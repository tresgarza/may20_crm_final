...
const Applications: React.FC = () => {
  ...
  return (
    <MainLayout>
      <div className="applications-page-container p-6">
        
        {/* Cabecera y Filtros (no cambia) */}
        ...
        {/* Contenido principal que se estira (el "recuadro azul") */}
        <div className="kanban-main-content bg-base-100 shadow-xl rounded-box mt-6">
          <div className="p-6 flex flex-col h-full">
            ...
            {/* Área de contenido que se estira (Kanban o Lista) */}
